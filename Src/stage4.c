...
@course CSD1121F22
@section Section A.
@brief This file contains logic needed for stage 4
All content © 2022 DigiPen (SINGAPORE) Corporation, all rights reserved.
*//*______________________________________________________________________*/
//Stage 4 Target Hiding behind boxes
#include <stdio.h>
...
void stage4_init(void)
{
	...
	background = CP_Image_Load("Assets/background 4.png");
...
void stage4_update(void)
{
	...
	CP_Color backgroundcolour = CP_Color_Create(140, 157, 140, 170);
	...
	if (gIsPaused == TRUE)
	{
		...
		if (CP_Input_MouseClicked(MOUSE_BUTTON_LEFT))
		{
			if (IsAreaClicked(1200, 800, 150, 60, CP_Input_GetMouseX(), CP_Input_GetMouseY()))
			{
				CP_Engine_SetNextGameState(stage5_init, stage5_update, stage5_exit);
			}
			if (IsAreaClicked(600, 800, 150, 60, CP_Input_GetMouseX(), CP_Input_GetMouseY()))
			{
